...
<div class="box">
	<div class="left">
		...
		<ul>
			<li class="a"><img src="./img/试卷图标.jpg" class="course"><a href="StudentMain.jsp">在线选课</a></li>
			<li class="a"><a href="ViewSelectedCourses.jsp"><img src="./img/试卷图标.jpg" class="course" />查看已选课程</a></li>
